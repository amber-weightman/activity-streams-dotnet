...
/// that are either instances of <c>Object</c> (here implemented as <see cref="IStreamsObject"/>) or <c>Link</c>. When a <c>Link</c> is used, it 
...
/// </code>
/// </example>
public interface IStreamsLink : ICoreType
{
    /// <summary>
    /// The target resource pointed to by a <c>Link</c> (here implemented as <see cref="IStreamsLink"/>).
    ...
    /// <summary>
    /// On a <c>Link</c> (here implemented as <see cref="IStreamsLink"/>), specifies a hint as to the rendering height in device-independent 
    ...
    /// <summary>
    /// On a <c>Link</c> (here implemented as <see cref="IStreamsLink"/>), specifies a hint as to the rendering width in device-independent pixels of the linked resource.
