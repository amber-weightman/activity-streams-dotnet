...
/// deleted. It can be used in <c>Collection</c>s (here implemented as <see cref="IStreamsCollection"/>) to signify that 
...
/// </code>
/// </example>
public interface ITombstone : IStreamsObject
{
    /// <summary>
